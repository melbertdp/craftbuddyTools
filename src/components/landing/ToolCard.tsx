...
const illustrationClass =
  "pointer-events-none relative -z-10 mt-4 h-[120px] w-full transition-transform duration-200 ease-out group-hover:-translate-y-[2px] group-hover:translate-x-[3px] motion-reduce:transform-none sm:absolute sm:inset-y-0 sm:right-0 sm:mt-0 sm:h-full sm:w-[46%]";
...
export function ToolCard({
  ...
  return (
    <article
      className={cn(
        "group relative isolate flex min-h-[210px] flex-col overflow-hidden rounded-2xl border p-4 shadow-[0_10px_30px_rgba(34,55,39,0.05)] transition duration-200 ease-out",
    ...
    >
      <div className="flex h-full flex-col sm:max-w-[58%]">
        ...
        <h2 className="mt-3 font-heading text-[25px] font-bold leading-[1.05] tracking-[-0.035em] text-[#20372b] sm:mt-4 sm:text-[28px]">
          {external ? (
        ...
        <p className="mt-2 max-w-[31ch] text-[14px] leading-[1.55] text-[#3f4d44]">
          {description}
        </p>
        <span
          className={cn(
